...
public class PublicKey extends Key {
   ...
   * @return a new PublicKey object
   */
  public static PublicKey fromHex(String hexString) throws InvalidKeyException, IllegalDataSizeException, DecoderException {
    final byte[] raw = Hex.decodeHex(hexString);
